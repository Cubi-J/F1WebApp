...
export default function NextRaceCard({ race }){
    ...
    return(
        <div className="w-full mb-6 p-6 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200">
            ...
            <p className="text-gray-800 dark:text-gray-200 font-medium">
                {nextRace.date} — {nextRace.formattedTime}
            </p>
            <div className="mt-4 w-full h-64 overflow-hidden rounded-lg shadow-md">
                {svgContent ? (
                    <div
